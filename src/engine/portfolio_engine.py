...
class LabeledPortfolioMetrics(PortfolioMetrics):
    """Extends standard metrics to include ticker labels for the final user."""
...
def optimize_portfolio(
    ...
    Loads data, builds the risk model, and finds the Tangency Portfolio.
    ...
    Returns:
        The optimal risky portfolio (100% equity, 0% cash).
    """
...
def _create_cash_portfolio(
    ...
    """Helper to create a 100% cash portfolio."""
    return {
